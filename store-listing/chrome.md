...
```
Copy or delete all cookies for the current page with one click. No extra features, local-only, privacy-first.
```
...
Open any website, click the Cookie Quick icon, and either copy every cookie or wipe them all. That's it. No cookie editor, no import/restore, no accounts, no analytics.

**Single Purpose:** Copy or delete all cookies for the current page.

**Privacy:** This extension processes cookies locally in the browser only. Cookie data is never transmitted to any external server. The extension does not use analytics, telemetry, tracking, or third-party services.
